...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Zafer'in Fotoğrafı</title>
    ...
    <body>
        <div class="AnaDiv">
            ...
            <div class="icerik">
                ...
                Set ara = Baglantim.Execute("Select Yorum from foto1")
            ...
            %>
                <table style="margin-left: 20px;margin-top: 60px;float: left" border="0">
                <tr>
                    <td rowspan="5"><img src="fotograflar1.jpg" alt="arkadaş" width="350px" height="350px"></td>
                ...
                <tr>
                    ...
                    <td>Bazı anılar vardır, 13.ay 25.saat gibidir anlamsız fakat çok değerlidir.</td>
                </tr>
            </table>
                <%
                    ...
                    ssql="select * from foto1 where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <center>
                <%
                    if sayfa>1 then
                %>
                    <a href="fotobilgi.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="fotobilgi.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="fotobilgi.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="fotobilgi.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
            <center>
                <form action="fotobilgi.asp" method="post">
