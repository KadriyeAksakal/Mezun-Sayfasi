...
<html lang="en">
    ...
    <body>
          <div class="AnaDiv">
            ...
            <div class="icerik">
                <center>
                    <form action="KisiAraTamam.asp" method="post">
                   <h4><i>Arama Yapmak İstediğiniz Kişinin Adı Soyadı:</i><input style="margin-left: 10px; margin-top:60px" type="text" name="Ara"><input style="color:  #d25313;margin-left: 10px; margin-top:60px" type="submit" value="Ara"></h4>
                    </form>
                </center>
            </div>
        </div>
