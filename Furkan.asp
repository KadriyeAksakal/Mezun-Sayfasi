...
<html lang="en">
    ...
    <body>
        ...
        ssql="select * from Kullanıcı_Bilgileri where Ad='Göker' and Soyad='Yıldız' ;"
        ...
        <div class="AnaDiv">
                ...
                <div id="giris">
                   <% 
                    ...
                    <%    
                            ...
                            if oRS.EOF then
                    %>
                    <form action="huseyin.asp" method="post">
            ...
            <div class="icerik">
                ...
                'Tablonun acilmasi:
                Tablom.Open "PFurkan_Yorum", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from PFurkan_Yorum")
            ...
            %>            
                ...
                <table border="0" style="margin-left: 20px;margin-top: 60px" >
                <tr>
                    <td rowspan="11"><img src="göker.jpeg" alt="Esra" style="width: 375px;height: 500px;"></td>
                ...
                <%
                    ...
                    ssql="select * from PFurkan_Yorum where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <center>
                ...
                if sayfa>1 then
                %>
                    <a href="Furkan.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="Furkan.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="Furkan.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="Furkan.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
            <center>
                <form action="Furkan.asp" method="post">
                <h2>Göker İle Olan Hatıranı Paylaş</h2>
