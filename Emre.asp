...
<html lang="en">
    ...
    <body>
        <%
            ...
            ssql="select * from Kullanıcı_Bilgileri where Ad='Kadriye' and Soyad='Aksakal' ;"
        ...
        <div class="AnaDiv">
            ...
            <div class="icerik">
                ...
                'Tablonun acilmasi:
                Tablom.Open "PEmre_Yorum", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from PEmre_Yorum")
            ...
            %>
               <table border="0" style="margin-left: 20px;margin-top: 50px" >
                <tr>
                    <td rowspan="11"><img src="kadriye4.jpg" alt="Esra" style="width: 400px;height: 500px;"></td>
             ...
             <%
                ...
                ssql="select * from PEmre_Yorum where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <center>
                ...
                if sayfa>1 then
                %>
                    <a href="Emre.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="Emre.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="Emre.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="Emre.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
            <center>
                <form action="Emre.asp" method="post">
                <h2>Kadriye İle Olan Hatıranı Paylaş</h2>
