...
<html lang="en">
    ...
    <body>
         <div class="AnaDiv">
            ...
            <div class="icerik">
                <center><img src="mezuniyet3.jpg" alt="hatıra defteri"  width="800px" height="700px" style="margin-top: 60px;margin-left: 20px">
                <h1>Bir Hababam Sınıfı Daha Mezun Oldu</h1>
                <h5>Birbirimizden hiç kopmayalım diyenler için...Yeniden 12 Fen C:)</h5>
                </center>
            </div>
        </div>
    </body>
