...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Kadriye'nin Fotoğrafı</title>
    ...
    <body>
        <div class="AnaDiv">
            ...
            <div class="icerik">
                ...
                'Tablonun acilmasi:
                Tablom.Open "foto3", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from foto3")
            ...
            %>
                ...
                <tr>
                    <td rowspan="5"><img src="fotograflar4.jpg" alt="arkadaş" width="450px" height="350px"></td>
                    <td style="width: 28%"><b>Fotoğrafı Paylaşan Kişi:</b></td>
                    <td>Kadriye Aksakal</td>
                </tr>
                 <tr>
            ...
            <%
                    ...
                    ssql="select * from foto3 where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <center>
                <%
                    if sayfa>1 then
                %>
                    <a href="fotoemre.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="fotoemre.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="fotoemre.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="fotoemre.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
                
            <center>
                <form action="fotoemre.asp" method="post">
