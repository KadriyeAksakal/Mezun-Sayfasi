          ...
          <div class="AnaDiv">
            ...
            <div class="icerik">
               <%
                ...
                Set ara = Baglantim.Execute("Select Yorum from Forum")
            ...
            <%
                ...
                ssql="select * from Forum where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            %>
             <table style="width: 95%;margin-left: 20px;margin-top: 90px;margin-right: 20px" border="1" class="tablo">
                <tr>
            ...
            <center>
                <%
                    if sayfa>1 then
                %>
                    <a href="Forum.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="Forum.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="Forum.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="Forum.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
             </center>
            <center>
                <form action="Forum.asp" method="post">                
                <h2>Muhabbete Sen De Katıl</h2>
