        ...
        <div class="AnaDiv">
            ...
            <div class="icerik">
                <%
                    ...
                    SQL = "delete * from Kullanıcı_Bilgileri where Ad+' '+Soyad='" & session("KullanıcıAdSoyadTut")& "';"
                    kayit_sil.Open sql, oConn, 1, 2
                    set kayit_sil=nothing
                    oConn.CLOSE
                    SET oConn = NOTHING
                        Response.write("<center><h1>Kullanıcı Bilgileri Başarıyla Silinmiştir</h1></center>")
                        response.write("<center><h4><u><a href='KisiAra.asp'>Arama Sayfasına Geri Dönmek İçin Tıklayınız</u></a></h4></center>")
