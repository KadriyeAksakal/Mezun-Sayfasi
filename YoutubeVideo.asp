        ...
        <div class="AnaDiv">
            ...
            <div class="icerik">
               <%
                ...
                'Tablonun acilmasi:
                Tablom.Open "video3", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from video3")
            ...
            %>
             <center>
                        <iframe src="https://www.youtube.com/embed/Y75Km7dlt94" style="width: 600px;height: 400px;margin-top: 60px"></iframe>  
            </center>
            <%
        
                    Set Conn = Server.CreateObject("ADODB.Connection")
                    Conn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("database.mdb"))
                    ssql="select * from video3 where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <table style="width: 95%;margin-top: 20px;margin-left: 20px" border="1" class="tablo">
                ...
                <%
                    if sayfa>1 then
                %>
                    <a href="YoutubeVideo.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="YoutubeVideo.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="YoutubeVideo.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="YoutubeVideo.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
             </center>
             <center>
                 <form action="YoutubeVideo.asp" method="post">
