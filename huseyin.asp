...
<html lang="en">
    ...
    <body>
        ...
        ssql="select * from Kullanıcı_Bilgileri where Ad='Münevver' and Soyad='Akdoğan' ;"
        ...
        <div class="AnaDiv">
            ...
            <div class="icerik">
                ...
                'Tablonun acilmasi:
                Tablom.Open "PHuseyin_Yorum", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from PHuseyin_Yorum")
            ...
            %>            
                ...
                <tr>
                    <td rowspan="11"><img src="münevver.jpeg" alt="Esra" style="width: 281px;height: 500px;"></td>
                ...
                <%
                    ...
                    ssql="select * from PHuseyin_Yorum where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <center>
                ...
                if sayfa>1 then
                %>
                    <a href="huseyin.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="huseyin.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="huseyin.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="huseyin.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
            <center>
                <form action="huseyin.asp" method="post">
                <h2>Münevver İle Olan Hatıranı Paylaş</h2>
