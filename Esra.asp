...
<html lang="en">
    ...
    <body>
        <%
            ...
            ssql="select * from Kullanıcı_Bilgileri where Ad='Ayşegül' and Soyad='Bulur' ;"
           ...
           <div class="AnaDiv">
                ...
                <div id="giris">
                  <%
                    ...
                    <%    
                            ...
                            if oRS.EOF then
                    %>
                    <form action="emre.asp" method="post">
            ...
            <div class="icerik">
               <%
                ...
                'Tablonun acilmasi:
                Tablom.Open "PEsra_Yorum", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from PEsra_Yorum")
            ...
            %>
                ...
                <tr>
                    <td rowspan="11"><img src="ayşegül.jpeg" alt="Esra" style="width: 375px;height: 500px;"></td>
            ...
            <%
                ...
                ssql="select * from PEsra_Yorum where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            <table border="1" style="margin-left: 20px;margin-right: 20px;width: 95%" class="tablo">
             ...
             <center>
                ...
                if sayfa>1 then
                %>
                    <a href="Esra.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="Esra.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="Esra.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="Esra.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
            </center>
            <center>
                <form action="Esra.asp" method="post">
                <h2>Ayşegül İle Olan Hatıranı Paylaş</h2>
