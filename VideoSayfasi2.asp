...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Mezuniyet Hatırası 2</title>
    ...
    <body>
         <div class="AnaDiv">
            ...
            <%
                ...
                'Tablonun acilmasi:
                Tablom.Open "video2", Baglantim, 1, 3      
                'Tabloya veri eklemeye baslangic:
                Tablom.Addnew
                'Tablodaki alanlara veri 
                Set ara = Baglantim.Execute("Select Yorum from video2")
            ...
            %>
            <center>
               <iframe width="560" height="315" src="https://www.youtube.com/embed/pFTkk22CbAg" style="width: 600px;height: 400px;margin-top: 60px"></iframe>        
            </center>
            <%
        
                    Set Conn = Server.CreateObject("ADODB.Connection")
                    Conn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("database.mdb"))
                    ssql="select * from video2 where Kullanıcı_Adı IS NOT NULL and Yorum IS NOT NULL and Tarih IS NOT NULL  order by Tarih ;"
            ...
            %>
            <table style="width: 95%;margin-top: 20px;margin-left: 20px" border="1" class="tablo">
                <tr>
              ...
              <center>
                <%
                    if sayfa>1 then
                %>
                    <a href="VideoSayfasi2.asp?Sayfa=<%=1%>"><B>|< İlk Sayfa </B></a>
                    <a href="VideoSayfasi2.asp?Sayfa=<%=sayfa-1%>"><span style="margin-left: 5px"><b>< Önceki Sayfa</b></span></a>
                <% end if%>
                    <span style="margin-left: 5px"><b> <%=sayfa%> / <%=sonsayfa%> </b></span>
                <%
                    if sonsayfa<>sayfa then
                %>
                    <a href="VideoSayfasi2.asp?sayfa=<%=sayfa+1%>"><span style="margin-left: 5px"><b>Sonraki Sayfa></b></span></a>
                    <a href="VideoSayfasi2.asp?sayfa=<%=sonsayfa%>"><span style="margin-left: 5px"><b>Son Sayfa >|</b></span></a>
               <%end if%>
               </center>
             <center>
                 <form action="VideoSayfasi2.asp" method="post">
                 <h2>Video İle Olan Hatıranı Paylaş</h2>
